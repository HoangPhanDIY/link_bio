            ...
            <div className="pt-2">
              {!(appearance.bankAccount || appearance.momoNumber) ? (
                <div className="text-center text-xs text-red-500 bg-red-50 dark:bg-red-950/30 p-3 rounded-xl border border-red-100 dark:border-red-900/30 font-semibold">
                  Chưa cấu hình tài khoản nhận ủng hộ. Admin vui lòng cấu hình
                  tài khoản trong phần Giao diện.
                </div>
              ) : (
                <button
                  type="submit"
        ...
        <div className="space-y-5 animate-in fade-in zoom-in-95 duration-300">
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <div className="flex gap-2">
                <div
                  className={`flex-1  font-black text-center text-lg py-2.5 px-3 rounded-lg border border-dashed select-all uppercase tracking-wider ${
                    isDarkPublic
          ...
          >
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-slate-400 mt-1">
                Hệ thống sẽ tự động chuyển hướng và điền thông tin chuyển khoản
                trên ứng dụng ngân hàng của bạn.
              </p>
            </div>
          </div>
          ...
          >
            <p className="font-bold flex items-start gap-1.5">
              ...
              Bước 1: Lưu ảnh QR ở trên HOẶC chọn ứng dụng ngân hàng của bạn rồi
              nhấn "Mở App" để chuyển khoản tự động.
            </p>
            <p className="font-bold flex items-start gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 shrink-0" />
              Bước 2: Kiểm tra số tiền chuyển khoản trùng khớp với yêu cầu ở
              trên.
            </p>
            <p className="font-bold flex items-start gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-slate-400 mt-1.5 shrink-0" />
              Bước 3: Nhấn chuyển khoản trên điện thoại. Sau khi chuyển khoản
              thành công, nhấn "Xác nhận đã chuyển" bên dưới.
            </p>
          </div>

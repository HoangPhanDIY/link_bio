...
export default function PhonePreview({
  ...
  const getFontFamilyClass = () => {
    ...
    if (fontFamily === "JetBrains Mono") return "";
    return "font-sans";
  };
          ...
          <div className="px-4 pt-4">
            <div className="h-28 w-full relative overflow-hidden rounded-3xl bg-indigo-950 shadow-sm">
              {bannerUrl ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-indigo-950 to-slate-950 opacity-90 flex items-center justify-center">

...
import { Facebook, Instagram, Tiktok, Youtube, Zalo, Github, Gmail, Google } from '@thesvg/react';
...
export default function BrandIcon({ title, iconName, className = '', size = 20 }: BrandIconProps) {

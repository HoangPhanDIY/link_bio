                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            />
                                            {!isRoot && (
                                              <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 z-20 bg-[#0a0a0f] border border-slate-800 text-[7.5px] md:text-[8.5px] font-black text-slate-300 px-1.5 py-0.5 rounded-full select-none shadow font-mono">
                                        ...
                                        return (
                                          ...
                                          >
                                            ...
                                            >
                                              ...
                                              />
                                              {!isRoot && (
                                                <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 z-20 bg-[#0a0a0f] border border-slate-800 text-[7px] font-black text-slate-300 px-1 py-0.5 rounded-full select-none shadow font-mono">
                                                  I
                                                </span>
                                              )}
                                            </div>
